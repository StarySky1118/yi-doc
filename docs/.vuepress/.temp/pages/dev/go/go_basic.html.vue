<template><div><h1 id="go-基础" tabindex="-1"><a class="header-anchor" href="#go-基础"><span>Go 基础</span></a></h1>
<h2 id="_1-环境安装" tabindex="-1"><a class="header-anchor" href="#_1-环境安装"><span>1.环境安装</span></a></h2>
...
<p>在工作目录中创建<code v-pre>test.go</code>文件。</p>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>打开命令窗口，输入<code v-pre>go run test.go</code>
<img src="/images/dev/go/go_basic/hello_go.png" alt="image.png"></p>
<h2 id="_2-基本结构和基本数据类型" tabindex="-1"><a class="header-anchor" href="#_2-基本结构和基本数据类型"><span>2. 基本结构和基本数据类型</span></a></h2>
<h3 id="_2-1-文件名、关键字与标识符" tabindex="-1"><a class="header-anchor" href="#_2-1-文件名、关键字与标识符"><span>2.1 文件名、关键字与标识符</span></a></h3>
...
<h3 id="_2-2-go-程序的基本结构和要素" tabindex="-1"><a class="header-anchor" href="#_2-2-go-程序的基本结构和要素"><span>2.2 Go 程序的基本结构和要素</span></a></h3>
<h4 id="_2-2-1-包的概念、导入与可见性" tabindex="-1"><a class="header-anchor" href="#_2-2-1-包的概念、导入与可见性"><span>2.2.1 包的概念、导入与可见性</span></a></h4>
...
<h4 id="_2-2-2-函数" tabindex="-1"><a class="header-anchor" href="#_2-2-2-函数"><span>2.2.2 函数</span></a></h4>
<p>函数的语法格式如下：</p>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>其中：</p>
<ul>
...
<h4 id="_2-2-3-注释" tabindex="-1"><a class="header-anchor" href="#_2-2-3-注释"><span>2.2.3 注释</span></a></h4>
...
<h4 id="_2-2-4-类型" tabindex="-1"><a class="header-anchor" href="#_2-2-4-类型"><span>2.2.4 类型</span></a></h4>
...
<h4 id="_2-2-5-go-程序的一般结构" tabindex="-1"><a class="header-anchor" href="#_2-2-5-go-程序的一般结构"><span>2.2.5 Go 程序的一般结构</span></a></h4>
<ul>
...
<li>如果当前包是<code v-pre>main</code>包，则定义<code v-pre>main()</code>函数。</li>
<li>然后定义其余的函数，首先是类型的方法，接着是按照<code v-pre>main()</code>函数中先后调用的顺序来定义相关函数，如果有很多函数，则可以按照字母顺序来进行排序。</li>
</ul>
<div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line"><span class="token keyword">package</span> main</span>
<span class="line"></span>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_2-2-6-类型转换" tabindex="-1"><a class="header-anchor" href="#_2-2-6-类型转换"><span>2.2.6 类型转换</span></a></h4>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div></div></div><p>具有相同底层类型的变量之间可以相互转换：</p>
<div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line"><span class="token keyword">type</span> IZ <span class="token builtin">int</span></span>
<span class="line"></span>
...
<h3 id="_2-2-3-常量" tabindex="-1"><a class="header-anchor" href="#_2-2-3-常量"><span>2.2.3 常量</span></a></h3>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>数字型的常量是没有大小和符号的，并且可以使用任何精度而不会导致溢出。
常量的并行赋值：</p>
<div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line"><span class="token keyword">const</span> Monday<span class="token punctuation">,</span> Tuesday<span class="token punctuation">,</span> Wednesday<span class="token punctuation">,</span> Thursday<span class="token punctuation">,</span> Friday<span class="token punctuation">,</span> Saturday <span class="token operator">=</span> <span class="token number">1</span><span class="token punctuation">,</span> <span class="token number">2</span><span class="token punctuation">,</span> <span class="token number">3</span><span class="token punctuation">,</span> <span class="token number">4</span><span class="token punctuation">,</span> <span class="token number">5</span><span class="token punctuation">,</span> <span class="token number">6</span></span>
...
<span class="line"><span class="token punctuation">)</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>常量用作枚举：</p>
...
在格式化输出时，你可以使用<code v-pre>%t</code>来表示你要输出的值为布尔型。</p>
<h3 id="_2-数字类型" tabindex="-1"><a class="header-anchor" href="#_2-数字类型"><span>(2) 数字类型</span></a></h3>
<p>Go 也有<strong>基于架构的类型</strong>，例如：<code v-pre>int</code>、<code v-pre>uint</code>和<code v-pre>uintptr</code>。
...
Go 中拥有以下逻辑运算符：<code v-pre>==</code>、<code v-pre>!=</code>、<code v-pre>&lt;</code>、<code v-pre>&lt;=</code>、<code v-pre>&gt;</code>、<code v-pre>&gt;=</code>。
算术运算符：<code v-pre>+</code>、<code v-pre>-</code>、<code v-pre>*</code>、<code v-pre>/</code>、<code v-pre>++</code>、<code v-pre>--</code>
包<code v-pre>unicode</code>包含了一些针对测试字符的非常有用的函数（其中 ch 代表字符）：</p>
<ul>
<li>判断是否为字母：<code v-pre>unicode.IsLetter(ch)</code></li>
<li>判断是否为数字：<code v-pre>unicode.IsDigit(ch)</code></li>
<li>判断是否为空白符号：<code v-pre>unicode.IsSpace(ch)</code></li>
</ul>
<p>这些函数返回单个布尔值。</p>
<h3 id="_3-类型别名——type" tabindex="-1"><a class="header-anchor" href="#_3-类型别名——type"><span>(3) 类型别名——<code v-pre>type</code></span></a></h3>
<p>使用语法：<code v-pre>type CUSTOM_TYPE_NAME int</code></p>
<div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line"><span class="token keyword">package</span> main</span>
<span class="line"></span>
<span class="line"><span class="token keyword">import</span> <span class="token string">"fmt"</span></span>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>类型别名得到的新类型并非和原类型完全相同，新类型不会拥有原类型所附带的方法。</p>
<h3 id="_4-字符类型" tabindex="-1"><a class="header-anchor" href="#_4-字符类型"><span>(4) 字符类型</span></a></h3>
<p>字符只是整数的特殊用例。<code v-pre>byte</code>类型是<code v-pre>uint8</code>的别名，<code v-pre>rune</code>类型是<code v-pre>unit16</code>的别名。格式化说明符 <code v-pre>%c</code>用于表示字符。</p>
<h2 id="_6、字符串" tabindex="-1"><a class="header-anchor" href="#_6、字符串"><span>6、字符串</span></a></h2>
<p>字符串是 UTF-8 字符的一个序列，字符串是一种<strong>值类型</strong>，且值不可变，即创建某个文本后你无法再次修改这个文本的内容；更深入地讲，字符串是字节的定长数组。<code v-pre>string</code>类型的零值为长度为零的字符串，即空字符串<code v-pre>&quot;&quot;</code>。一般的比较运算符（<code v-pre>==</code>、<code v-pre>!=</code>、<code v-pre>&lt;</code>、<code v-pre>&lt;=</code>、<code v-pre>&gt;=</code>、<code v-pre>&gt;</code>）通过在内存中按字节比较来实现字符串的对比。获取字符串中某个字节的地址的行为是非法的，例如：<code v-pre>&amp;str[i]</code>。
可以通过函数<code v-pre>len()</code>来获取字符串所占的字节长度，例如：<code v-pre>len(str)</code>。</p>
<h2 id="_7、strings和strconv包" tabindex="-1"><a class="header-anchor" href="#_7、strings和strconv包"><span>7、<code v-pre>strings</code>和<code v-pre>strconv</code>包</span></a></h2>
<p>Go 中使用<code v-pre>strings</code>包来完成对字符串的主要操作。
<code v-pre>strings</code>包中包括判断前后缀、判断包含关系、子串在父串中的索引、字符串替换、统计字符串出现次数、修改字符串大小写、字符串修剪、字符串分割、字符串拼接。</p>
<div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line"><span class="token keyword">package</span> main</span>
<span class="line"></span>
<span class="line"><span class="token keyword">import</span> <span class="token punctuation">(</span></span>
<span class="line">	<span class="token string">"fmt"</span></span>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>与字符串相关的类型转换都是通过<code v-pre>strconv</code>包实现的。</p>
<h2 id="_8、时间和日期" tabindex="-1"><a class="header-anchor" href="#_8、时间和日期"><span>8、时间和日期</span></a></h2>
<p><code v-pre>time</code>包为我们提供了一个数据类型<code v-pre>time.Time</code>（作为值使用）以及显示和测量时间和日期的功能函数。当前时间可以使用<code v-pre>time.Now()</code>获取，使用<code v-pre>t.Day()</code>、<code v-pre>t.Minute()</code>等等来获取时间的一部分。</p>
<h2 id="_9、指针" tabindex="-1"><a class="header-anchor" href="#_9、指针"><span>9、指针</span></a></h2>
<p>Go 中无法进行指针运算。**一个指针变量可以指向任何一个值的内存地址。**它指向那个值的内存地址，在 32 位机器上占用 4 个字节，在 64 位机器上占用 8 个字节，并且与它所指向的值的大小无关。指针的格式化标识符为<code v-pre>%p</code>。符号<code v-pre>*</code>可以放在一个指针前，如<code v-pre>*intP</code>，那么它将得到这个指针指向地址上所存储的值，这被称为反引用（或者内容或者间接引用）操作符。
一个指针变量通常缩写为<code v-pre>ptr</code>。</p>
<h1 id="三、控制结构" tabindex="-1"><a class="header-anchor" href="#三、控制结构"><span>三、控制结构</span></a></h1>
...
<h1 id="四、函数" tabindex="-1"><a class="header-anchor" href="#四、函数"><span>四、函数</span></a></h1>
...
<p>数组长度也是数组类型的一部分，<code v-pre>[5]int</code>和<code v-pre>[10]int</code>是属于不同类型的。Go 语言中的数组是一种<strong>值类型，<strong>因此可以通过<code v-pre>new()</code>来创建</strong>。</strong>
:::info
Go 语言中，<code v-pre>new()</code>可以得到某类型零值的指针。
在 Go 语言中，<code v-pre>new()</code>函数用于创建一个指向新分配的零值的指针。它的主要作用是为值类型（如整数、浮点数、结构体等）分配内存，并返回一个指向该内存的指针。这个指针指向的内存已经被初始化为零值。
语法如下：
<code v-pre>ptr := new(Type)</code>
:::</p>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><h1 id="六、map" tabindex="-1"><a class="header-anchor" href="#六、map"><span>六、Map</span></a></h1>
<p>map 声明语法如下：</p>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="七、结构体与方法" tabindex="-1"><a class="header-anchor" href="#七、结构体与方法"><span>七、结构体与方法</span></a></h1>
<p>结构体也是<strong>值类型</strong>，因此可以通过<code v-pre>new()</code>函数来创建。组成结构体类型的那些数据称为<strong>字段（fields）</strong>。</p>
<h2 id="_1、结构体定义" tabindex="-1"><a class="header-anchor" href="#_1、结构体定义"><span>1、结构体定义</span></a></h2>
<p>结构体定义格式：</p>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>赋值语法如下：</p>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>可以使用<code v-pre>new()</code>创建结构体零值，并返回指针：</p>
<div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line">t <span class="token operator">:=</span> <span class="token function">new</span><span class="token punctuation">(</span>T<span class="token punctuation">)</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><p>在 Go 中，<code v-pre>.</code>称为选择器，无论变量是一个结构体类型还是一个结构体类型指针，都使用同样的<strong>选择器符</strong>来引用结构体的字段：</p>
<div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line"><span class="token keyword">package</span> main</span>
<span class="line"></span>
<span class="line"><span class="token keyword">import</span> <span class="token string">"fmt"</span></span>
<span class="line"></span>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_2、使用工厂方法创建结构体实例" tabindex="-1"><a class="header-anchor" href="#_2、使用工厂方法创建结构体实例"><span>2、使用工厂方法创建结构体实例</span></a></h2>
<p>Go 语言不支持面向对象编程语言中那样的构造子方法，但是可以很容易的在 Go 中实现&quot;构造子工厂&quot;方法。为了方便通常会为类型定义一个工厂，按惯例，工厂的名字以<code v-pre>new</code>或<code v-pre>New</code>开头。</p>
<div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line"><span class="token keyword">package</span> main</span>
<span class="line"></span>
<span class="line"><span class="token keyword">import</span> <span class="token punctuation">(</span></span>
<span class="line">	<span class="token string">"fmt"</span></span>
...
<h2 id="_3、方法" tabindex="-1"><a class="header-anchor" href="#_3、方法"><span>3、方法</span></a></h2>
<h3 id="_1-概念" tabindex="-1"><a class="header-anchor" href="#_1-概念"><span>(1) 概念</span></a></h3>
<p>Go 方法是作用在接收者上的一个函数，接收者是某种类型的变量。一个类型加上它的方法等价于面向对象中的一个类。一个重要的区别是：在 Go 中，类型的代码和绑定在它上面的方法的代码可以不放置在一起，它们可以存在在不同的源文件，唯一的要求是：它们必须是同一个包的。
方法定义语法：</p>
<div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line"><span class="token keyword">func</span> <span class="token punctuation">(</span>recv receiver_type<span class="token punctuation">)</span> <span class="token function">methodName</span><span class="token punctuation">(</span>parameter_list<span class="token punctuation">)</span> <span class="token punctuation">(</span>return_value_list<span class="token punctuation">)</span> <span class="token punctuation">{</span> <span class="token operator">...</span> <span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><p><code v-pre>recv</code>就像是面向对象语言中的<code v-pre>this</code>或<code v-pre>self</code>，但是 Go 中并没有这两个关键字。随个人喜好，可以使用<code v-pre>this</code>或<code v-pre>self</code>作为接收者的名字。</p>
<div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line"><span class="token keyword">package</span> main</span>
<span class="line"></span>
<span class="line"><span class="token keyword">import</span> <span class="token string">"fmt"</span></span>
<span class="line"></span>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-getter-setter" tabindex="-1"><a class="header-anchor" href="#_2-getter-setter"><span>(2) getter &amp; setter</span></a></h3>
<p>使用方法可以实现<code v-pre>getter</code>和<code v-pre>setter</code>。</p>
<h3 id="_3-内嵌类型方法与继承" tabindex="-1"><a class="header-anchor" href="#_3-内嵌类型方法与继承"><span>(3) 内嵌类型方法与继承</span></a></h3>
<p>当一个匿名类型被内嵌在结构体中时，匿名类型的可见方法也同样被内嵌，这在效果上等同于外层类型<strong>继承</strong>了这些方法：</p>
<div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line"><span class="token keyword">package</span> main</span>
<span class="line"></span>
<span class="line"><span class="token keyword">import</span> <span class="token string">"fmt"</span></span>
<span class="line"></span>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="八、接口与反射" tabindex="-1"><a class="header-anchor" href="#八、接口与反射"><span>八、接口与反射</span></a></h1>
