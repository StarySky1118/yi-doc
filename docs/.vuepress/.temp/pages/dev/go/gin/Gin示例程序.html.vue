<template><div><h1 id="一、gin-示例程序" tabindex="-1"><a class="header-anchor" href="#一、gin-示例程序"><span>一、Gin 示例程序</span></a></h1>
<h2 id="_1、搭建-gin-服务器步骤" tabindex="-1"><a class="header-anchor" href="#_1、搭建-gin-服务器步骤"><span>1、搭建 Gin 服务器步骤</span></a></h2>
<ol>
<li>初始化一个 Go 模块</li>
</ol>
<div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line"><span class="token keyword">go</span> mod init 模块名称</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><p><code v-pre>go mod init</code>命令用于初始化一个 Go 模块，其作用如下：</p>
<ol>
<li>创建模块文件：命令会在当前目录下创建一个新的<code v-pre>go.mod</code>文件，该文件用于记录项目依赖关系和模块信息。</li>
<li>定义模块名称：运行该命令需要提供一个模块名称作为参数。这个名称通常是一个包含项目的源代码的版本库的路径（例如，GitHub 或 GitLab 上的路径），它将成为您的项目的唯一标识符。</li>
<li>初始化依赖关系：命令会初始化一个依赖关系图，它会随着添加和删除依赖包而变化。这个依赖关系图会记录项目中使用的外部包，以及它们的版本信息。</li>
</ol>
<div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line"><span class="token keyword">go</span> mod init gin<span class="token operator">-</span>demo</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><ol start="2">
<li>在 GoLand 中打开目录</li>
</ol>
<p>配置 Go Module 代理地址：<code v-pre>https://goproxy.io</code>
<img src="/images/dev/go/gin/moudle_proxy.png" alt="image.png"></p>
<ol start="3">
<li>创建<code v-pre>main.go</code>文件</li>
</ol>
...
<li>获取<code v-pre>Gin</code>包</li>
</ol>
<p>运行项目，根据提示使用<code v-pre>go get</code>命令获取<code v-pre>gin</code>包。</p>
<p><code v-pre>go get</code>命令用于从远程代码仓库中获取并安装 Go 包（也称为模块），具体如下：</p>
<ol>
<li>
<p>下载和安装包：命令可以从指定的远程代码仓库中下载 Go 包，并将其安装到 <code v-pre>GOPATH</code> 中。</p>
</li>
<li>
<p>自动导入包：一旦包被下载并安装，还会自动更新项目代码以导入和使用这些包。这使得可以方便地将其他人编写的 Go 代码集成到自己的项目中。</p>
</li>
<li>
<p>版本管理：命令可以使用版本标签（tag）或分支（branch）信息，以确保获取的是特定版本的包。这有助于管理项目的依赖关系和确保构建的稳定性。</p>
</li>
<li>
<p>更新依赖：如果之前使用该命令安装了某个包，并且想要更新该包以获取新的功能或修复错误，您可以再次运行命令来更新包。</p>
<p>安装成功后，代码将不会再提示找不到包。
运行即可：
<img src="/images/dev/go/gin/gin_run.png" alt="image.png"></p>
</li>
</ol>
<h2 id="_2、接口参数获取" tabindex="-1"><a class="header-anchor" href="#_2、接口参数获取"><span>2、接口参数获取</span></a></h2>
<h3 id="_1-get-请求获取路径参数和请求参数" tabindex="-1"><a class="header-anchor" href="#_1-get-请求获取路径参数和请求参数"><span>(1) GET 请求获取路径参数和请求参数</span></a></h3>
<p>路径参数和请求参数直接从<code v-pre>context</code>中获取。</p>
<div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line"><span class="token keyword">package</span> main</span>
<span class="line"></span>
<span class="line"><span class="token keyword">import</span> <span class="token string">"github.com/gin-gonic/gin"</span></span>
<span class="line"></span>
...
<span class="line"></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong><code v-pre>gin.H{}</code></strong></p>
<p><code v-pre>gin.H{}</code>是一个用于创建并初始化一个<code v-pre>map[string]interface{}</code>类型的字典。<code v-pre>gin.H{}</code>通常用于构建 HTTP 响应的 JSON 数据或设置请求的参数。其作用如下：</p>
<ol>
<li>创建映射：<code v-pre>gin.H{}</code>创建了一个空的映射，可以在其中添加键值对，用于表示不同的数据。</li>
<li>构建 JSON 响应：在 Gin 框架中，可以使用<code v-pre>gin.H{}</code>构建 HTTP 响应的 JSON 数据。可以向其中添加键值对，表示要返回的 JSON 数据的字段和值。</li>
</ol>
<div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line">c<span class="token punctuation">.</span><span class="token function">JSON</span><span class="token punctuation">(</span>http<span class="token punctuation">.</span>StatusOK<span class="token punctuation">,</span> gin<span class="token punctuation">.</span>H<span class="token punctuation">{</span></span>
...
<span class="line"></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-post-请求获取请求体中的参数" tabindex="-1"><a class="header-anchor" href="#_2-post-请求获取请求体中的参数"><span>(2) POST 请求获取请求体中的参数</span></a></h3>
<p>请求体使用结构体接收。</p>
<div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line"><span class="token keyword">package</span> main</span>
<span class="line"></span>
...
<span class="line"></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-文件的接收与返回" tabindex="-1"><a class="header-anchor" href="#_3-文件的接收与返回"><span>(3) 文件的接收与返回</span></a></h3>
<h4 id="接收文件" tabindex="-1"><a class="header-anchor" href="#接收文件"><span>接收文件</span></a></h4>
<p>使用<code v-pre>form-data</code>接收文件，使用<code v-pre>SaveUploadedFile()</code>保存文件。</p>
<div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line"><span class="token keyword">package</span> main</span>
<span class="line"></span>
<span class="line"><span class="token keyword">import</span> <span class="token punctuation">(</span></span>
<span class="line">	<span class="token string">"github.com/gin-gonic/gin"</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>请求：
<img src="/images/dev/go/gin/interface_test.png" alt="image.png"></p>
<h4 id="传送文件到前端" tabindex="-1"><a class="header-anchor" href="#传送文件到前端"><span>传送文件到前端</span></a></h4>
<div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line"><span class="token keyword">package</span> main</span>
<span class="line"></span>
<span class="line"><span class="token keyword">import</span> <span class="token punctuation">(</span></span>
<span class="line">	<span class="token string">"github.com/gin-gonic/gin"</span></span>
...
<span class="line"></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_3、路由分组与中间件" tabindex="-1"><a class="header-anchor" href="#_3、路由分组与中间件"><span>3、路由分组与中间件</span></a></h2>
<h4 id="路由分组" tabindex="-1"><a class="header-anchor" href="#路由分组"><span>路由分组</span></a></h4>
<p>使用路由分组代码结构更清晰、可维护，并且同一个路由分组会共享中间件。</p>
<div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line"><span class="token keyword">package</span> main</span>
<span class="line"></span>
<span class="line"><span class="token keyword">import</span> <span class="token punctuation">(</span></span>
<span class="line">	<span class="token string">"github.com/gin-gonic/gin"</span></span>
...
<span class="line"></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="中间件" tabindex="-1"><a class="header-anchor" href="#中间件"><span>中间件</span></a></h4>
<p>Gin 中的中间件指请求到达路由之前或之后执行的操作，其执行顺序符合洋葱模型：
<img src="/images/dev/go/gin/union.png" alt="image.png"></p>
<p>在 Gin 框架中，中间件（Middleware）是一种在请求到达路由处理函数之前或之后执行的函数或操作。中间件用于对请求进行预处理、增加额外的功能、进行身份验证、记录日志、修改请求或响应等操作。它们是一种非常有用的机制，用于增强和扩展 Web 应用程序的功能。
以下是一些中间件的常见应用场景和概念：</p>
<ol>
<li><strong>身份验证和授权</strong>：中间件可以用于验证用户的身份并授权访问特定的路由或资源。例如，可以创建一个中间件来检查用户是否已登录，并根据其角色授权对某些路由的访问权限。</li>
<li><strong>日志记录</strong>：中间件可以用于记录请求和响应的信息，以便进行调试和监控。可以记录请求的方法、路径、响应状态码等信息，并将其存储在日志文件或数据库中。</li>
<li><strong>跨域资源共享 (CORS)</strong>：中间件可以帮助处理跨域请求，添加必要的响应头，以允许或限制跨域请求。</li>
<li><strong>压缩响应</strong>：中间件可以用于压缩响应内容，减小传输数据的大小，提高性能。</li>
<li><strong>请求数据解析</strong>：中间件可以用于解析请求的数据，例如 JSON、表单数据或查询参数，并将其转换为可用于处理的数据结构。</li>
<li><strong>缓存控制</strong>：中间件可以添加响应头来控制客户端和代理服务器的缓存行为。</li>
<li><strong>错误处理</strong>：中间件可以用于捕获处理函数中的错误，并返回适当的错误响应。这有助于统一的错误处理逻辑。</li>
<li><strong>安全性</strong>：中间件可以帮助保护应用程序免受常见的 Web 攻击，如 CSRF（跨站请求伪造）和 XSS（跨站脚本攻击）。</li>
</ol>
<p>自定义中间件、使用中间件：
定义中间件函数需要返回<code v-pre>gin.HandlerFunc</code>类型。使用中间件可以链式方式调用。</p>
<div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line"><span class="token keyword">package</span> main</span>
<span class="line"></span>
<span class="line"><span class="token keyword">import</span> <span class="token punctuation">(</span></span>
...
<span class="line"></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_4、gorm" tabindex="-1"><a class="header-anchor" href="#_4、gorm"><span>4、GORM</span></a></h2>
<h4 id="使用步骤" tabindex="-1"><a class="header-anchor" href="#使用步骤"><span>使用步骤</span></a></h4>
<ol>
<li>安装 GORM</li>
</ol>
<div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line"><span class="token keyword">go</span> get <span class="token operator">-</span>u gorm<span class="token punctuation">.</span>io<span class="token operator">/</span>gorm</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><ol start="2">
<li>安装 MySQL 驱动</li>
</ol>
<div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line"><span class="token keyword">go</span> get <span class="token operator">-</span>u gorm<span class="token punctuation">.</span>io<span class="token operator">/</span>driver<span class="token operator">/</span>mysql</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><ol start="3">
<li>示例代码</li>
</ol>
<p>在 GORM 中，结构体与表一一对应，使用结构体标识一张表。</p>
<div class="language-go line-numbers-mode" data-highlighter="prismjs" data-ext="go" data-title="go"><pre v-pre><code><span class="line"><span class="token keyword">package</span> main</span>
<span class="line"></span>
<span class="line"><span class="token keyword">import</span> <span class="token punctuation">(</span></span>
<span class="line">	<span class="token string">"fmt"</span></span>
