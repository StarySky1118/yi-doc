<template><div><h1 id="三、selenium-api" tabindex="-1"><a class="header-anchor" href="#三、selenium-api"><span>三、Selenium-API</span></a></h1>
<h2 id="_1、元素定位" tabindex="-1"><a class="header-anchor" href="#_1、元素定位"><span>1、元素定位</span></a></h2>
<p>元素定位：通过元素的属性信息和元素的层级信息进行定位。
Selenium 提供了八种元素定位方式：</p>
<ol>
<li>id</li>
<li>name</li>
<li>class_name：类名</li>
<li>tag_name：标签名</li>
<li>link_text：定位超链接</li>
<li>partial_link_text：定位超链接，模糊</li>
<li>Xpath：基于元素路径定位</li>
<li>css：基于元素选择器定位</li>
</ol>
<h3 id="_1-id-定位" tabindex="-1"><a class="header-anchor" href="#_1-id-定位"><span>(1) id 定位</span></a></h3>
<p>使用前提：元素有 id 属性。
语法：<code v-pre>element = browser.find_element_by_id(元素id)</code></p>
<p><strong>使用案例</strong></p>
<p><img src="@source/dev/test/web_test/img_2.png" alt="img_2.png"></p>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在 Selenium 中，<code v-pre>send_keys()</code>方法用于向输入框或可编辑的元素发送文本，它模拟用户在键盘上输入文本的操作。
使用语法：<code v-pre>element.send_keys(*value)</code></p>
<h3 id="_2-name-定位" tabindex="-1"><a class="header-anchor" href="#_2-name-定位"><span>(2) name 定位</span></a></h3>
<p>使用前提：元素有 name 属性。
注意：HTML 中的 name 属性是可以重复的。
语法：<code v-pre>driver.find_element_by_name(name)</code></p>
<p><strong>使用案例</strong></p>
<p><img src="@source/dev/test/web_test/img_3.png" alt="img_3.png"></p>
<div class="language-python line-numbers-mode" data-highlighter="prismjs" data-ext="py" data-title="py"><pre v-pre><code><span class="line"><span class="token keyword">from</span> selenium <span class="token keyword">import</span> webdriver</span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-class-name-定位" tabindex="-1"><a class="header-anchor" href="#_3-class-name-定位"><span>(3) class_name 定位</span></a></h3>
<p>说明：使用 HTML 元素类名进行定位。多个 HTML 元素可以有相同的类名。</p>
<p>语法：<code v-pre>browser.find_element_by_class_name(class_name)</code></p>
<p><strong>使用案例</strong></p>
<p><img src="@source/dev/test/web_test/img_4.png" alt="img_4.png"></p>
<div class="language-python line-numbers-mode" data-highlighter="prismjs" data-ext="py" data-title="py"><pre v-pre><code><span class="line"><span class="token keyword">import</span> time</span>
<span class="line"></span>
<span class="line"><span class="token keyword">from</span> selenium <span class="token keyword">import</span> webdriver</span>
<span class="line"></span>
...
<span class="line">browser<span class="token punctuation">.</span>quit<span class="token punctuation">(</span><span class="token punctuation">)</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-tag-name-定位" tabindex="-1"><a class="header-anchor" href="#_4-tag-name-定位"><span>(4) tag_name 定位</span></a></h3>
<p>说明：通过元素标签名进行定位，不方便进行精准定位，很少使用。</p>
<p>如果有多个元素，只会定位第一个。</p>
<p>语法：<code v-pre>driver.find_element_by_tag_name(tag_name)</code></p>
<p><strong>使用案例</strong></p>
<p><img src="@source/dev/test/web_test/img_5.png" alt="img_5.png"></p>
<div class="language-python line-numbers-mode" data-highlighter="prismjs" data-ext="py" data-title="py"><pre v-pre><code><span class="line"><span class="token keyword">import</span> time</span>
<span class="line"></span>
<span class="line"><span class="token keyword">from</span> selenium <span class="token keyword">import</span> webdriver</span>
<span class="line"></span>
...
<span class="line">browser<span class="token punctuation">.</span>quit<span class="token punctuation">(</span><span class="token punctuation">)</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_5-link-text-定位" tabindex="-1"><a class="header-anchor" href="#_5-link-text-定位"><span>(5) link_text 定位</span></a></h3>
<p>专门用于定位超链接元素(<code v-pre>&lt;a&gt;</code>标签)，根据超链接文本内容定位元素。</p>
<p>语法：<code v-pre>element = driver.find_element_by_link_text(link_text)</code></p>
<ul>
<li><code v-pre>link_text</code>为超链接全部文本内容</li>
</ul>
<p><strong>使用案例</strong></p>
<p><img src="@source/dev/test/web_test/img_6.png" alt="img_6.png"></p>
<div class="language-python line-numbers-mode" data-highlighter="prismjs" data-ext="py" data-title="py"><pre v-pre><code><span class="line"><span class="token keyword">import</span> time</span>
<span class="line"></span>
<span class="line"><span class="token keyword">from</span> selenium <span class="token keyword">import</span> webdriver</span>
<span class="line"></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote>
<p><code v-pre>click()</code>方法会触发元素的单击事件。</p>
</blockquote>
<h3 id="_6-partial-link-text-定位" tabindex="-1"><a class="header-anchor" href="#_6-partial-link-text-定位"><span>(6) partial_link_text 定位</span></a></h3>
<p>说明：partial_link_text 定位是对 link_text 定位的补充，模糊匹配。</p>
<p>语法：<code v-pre>element = driver.find_element_by_partial_link_text(partial_link_text)</code></p>
<p><strong>使用案例</strong></p>
<p><img src="@source/dev/test/web_test/img_8.png" alt="img_8.png"></p>
<div class="language-python line-numbers-mode" data-highlighter="prismjs" data-ext="py" data-title="py"><pre v-pre><code><span class="line"><span class="token keyword">import</span> time</span>
<span class="line"></span>
<span class="line"><span class="token keyword">from</span> selenium <span class="token keyword">import</span> webdriver</span>
<span class="line"></span>
...
<span class="line">browser<span class="token punctuation">.</span>quit<span class="token punctuation">(</span><span class="token punctuation">)</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_7-定位一组元素" tabindex="-1"><a class="header-anchor" href="#_7-定位一组元素"><span>(7) 定位一组元素</span></a></h3>
<p>返回所有定位到的元素列表。</p>
<p>语法：<code v-pre>find_elements_by_xxx()</code></p>
<p><strong>使用案例</strong></p>
<p><img src="@source/dev/test/web_test/img_9.png" alt="img_9.png"></p>
<div class="language-python line-numbers-mode" data-highlighter="prismjs" data-ext="py" data-title="py"><pre v-pre><code><span class="line"><span class="token keyword">import</span> time</span>
<span class="line"></span>
<span class="line"><span class="token keyword">from</span> selenium <span class="token keyword">import</span> webdriver</span>
<span class="line"></span>
...
<span class="line">browser<span class="token punctuation">.</span>quit<span class="token punctuation">(</span><span class="token punctuation">)</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_8-xpath-定位" tabindex="-1"><a class="header-anchor" href="#_8-xpath-定位"><span>(8) Xpath 定位</span></a></h3>
<p>出现原因：很多元素无法通过<code v-pre>id</code>、<code v-pre>name</code>或<code v-pre>class_name</code>定位，如：</p>
<p><img src="@source/dev/test/web_test/img_10.png" alt="img_10.png"></p>
<p>语法：<code v-pre>element = driver.find_element_by_xpath(xpath)</code></p>
<h4 id="_1-何为-xpath" tabindex="-1"><a class="header-anchor" href="#_1-何为-xpath"><span>1.何为 Xpath？</span></a></h4>
<p>Xpath 是 XML path 的简称，HTML 是 XML 的一种实现，Xpath 定位就是通过 XML 语言进行定位。</p>
<h4 id="_2-xpath-定位方法" tabindex="-1"><a class="header-anchor" href="#_2-xpath-定位方法"><span>2.Xpath 定位方法</span></a></h4>
<ol>
<li>路径定位（绝对路径、相对路径）</li>
</ol>
<p>绝对路径：从最外层元素到指定元素之间所有经过元素层级的路径。</p>
<p><img src="@source/dev/test/web_test/img_11.png" alt="img_11.png"></p>
<p>相对路径：匹配任意层级的元素，不限制元素的位置。</p>
<p><img src="@source/dev/test/web_test/img_12.png" alt="img_12.png"></p>
<p><strong>使用案例</strong></p>
<p><img src="@source/dev/test/web_test/img_13.png" alt="img_13.png"></p>
<div class="language-python line-numbers-mode" data-highlighter="prismjs" data-ext="py" data-title="py"><pre v-pre><code><span class="line"><span class="token keyword">import</span> time</span>
<span class="line"></span>
<span class="line"><span class="token keyword">from</span> selenium <span class="token keyword">import</span> webdriver</span>
<span class="line"></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote>
<p><code v-pre>clear()</code>方法可以清除元素的内容。</p>
</blockquote>
<ol start="2">
<li>利用元素属性</li>
</ol>
<p>通过元素的属性信息来定位元素。
格式：<code v-pre>//input[@id='userA']</code>或<code v-pre>//#[@id='userA']</code></p>
<p><strong>使用案例</strong></p>
<p><img src="@source/dev/test/web_test/img_14.png" alt="img_14.png"></p>
<div class="language-python line-numbers-mode" data-highlighter="prismjs" data-ext="py" data-title="py"><pre v-pre><code><span class="line"><span class="token keyword">import</span> time</span>
<span class="line"></span>
<span class="line"><span class="token keyword">from</span> selenium <span class="token keyword">import</span> webdriver</span>
<span class="line"></span>
...
<p>使用多个属性，解决多个元素属性不匹配的问题。
格式：<code v-pre>//*[@name=&quot;tel&quot; and @class=&quot;tel&quot;]</code></p>
<p><strong>使用案例</strong></p>
<p><img src="@source/dev/test/web_test/img_15.png" alt="img_15.png"></p>
<div class="language-python line-numbers-mode" data-highlighter="prismjs" data-ext="py" data-title="py"><pre v-pre><code><span class="line"><span class="token keyword">import</span> time</span>
<span class="line"></span>
<span class="line"><span class="token keyword">from</span> selenium <span class="token keyword">import</span> webdriver</span>
<span class="line"></span>
...
<p>灵活使用层级、属性进行定位。</p>
<p>语法：<code v-pre>//*[@id='p1']/input</code></p>
<p><strong>使用案例</strong></p>
<p><img src="@source/dev/test/web_test/img_16.png" alt="img_16.png"></p>
<div class="language-python line-numbers-mode" data-highlighter="prismjs" data-ext="py" data-title="py"><pre v-pre><code><span class="line"><span class="token keyword">import</span> time</span>
<span class="line"></span>
<span class="line"><span class="token keyword">from</span> selenium <span class="token keyword">import</span> webdriver</span>
<span class="line"></span>
...
<span class="line"></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>知识拓展：Xpath 定位其他方式</strong>
<img src="@source/dev/test/web_test/img_17.png" alt="img_17.png"></p>
<h3 id="_9-css-定位" tabindex="-1"><a class="header-anchor" href="#_9-css-定位"><span>(9) css 定位</span></a></h3>
<p>在 selenium 中推荐使用 css 定位，它比 xpath 定位要快。
语法：<code v-pre>element = driver.find_element_by_css_selector(css_selector)</code>
css 常用的定位方式：</p>
<ul>
<li>id 选择器：<code v-pre>#id</code></li>
<li>class 选择器：<code v-pre>.class</code></li>
<li>元素选择器：<code v-pre>element</code></li>
<li>属性选择器：<code v-pre>element[attribute=value]</code></li>
<li>层级选择器：</li>
</ul>
<p>直接子元素：<code v-pre>element_father &gt; element_son</code></p>
<p>后代元素：<code v-pre>element_ancestor element_descendant</code></p>
<p><img src="@source/dev/test/web_test/img_18.png" alt="img_18.png"></p>
<p><strong>使用案例</strong></p>
<p><img src="@source/dev/test/web_test/img_19.png" alt="img_19.png"></p>
<div class="language-python line-numbers-mode" data-highlighter="prismjs" data-ext="py" data-title="py"><pre v-pre><code><span class="line"><span class="token keyword">import</span> time</span>
<span class="line"></span>
<span class="line"><span class="token keyword">from</span> selenium <span class="token keyword">import</span> webdriver</span>
<span class="line"></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote>
<p><strong>拓展知识：css 其他定位方式</strong>
<img src="@source/dev/test/web_test/img_20.png" alt="img_20.png"></p>
</blockquote>
<h2 id="_2、元素操作与浏览器操作" tabindex="-1"><a class="header-anchor" href="#_2、元素操作与浏览器操作"><span>2、元素操作与浏览器操作</span></a></h2>
<h3 id="_1-元素常用操作方法" tabindex="-1"><a class="header-anchor" href="#_1-元素常用操作方法"><span>(1) 元素常用操作方法</span></a></h3>
<div class="language-python line-numbers-mode" data-highlighter="prismjs" data-ext="py" data-title="py"><pre v-pre><code><span class="line"><span class="token comment"># 单击元素</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>使用案例</strong></p>
<p><img src="@source/dev/test/web_test/img_21.png" alt="img_21.png"></p>
<div class="language-python line-numbers-mode" data-highlighter="prismjs" data-ext="py" data-title="py"><pre v-pre><code><span class="line"><span class="token keyword">import</span> time</span>
<span class="line"></span>
<span class="line"><span class="token keyword">from</span> selenium <span class="token keyword">import</span> webdriver</span>
<span class="line"></span>
...
<div class="language-python line-numbers-mode" data-highlighter="prismjs" data-ext="py" data-title="py"><pre v-pre><code><span class="line"><span class="token comment"># 最大化浏览器</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-获取元素信息" tabindex="-1"><a class="header-anchor" href="#_3-获取元素信息"><span>(3) 获取元素信息</span></a></h3>
<p><img src="@source/dev/test/web_test/img_22.png" alt="img_22.png"></p>
<p><strong>使用案例</strong></p>
<p><img src="@source/dev/test/web_test/img_23.png" alt="img_23.png"></p>
<div class="language-python line-numbers-mode" data-highlighter="prismjs" data-ext="py" data-title="py"><pre v-pre><code><span class="line"><span class="token keyword">import</span> time</span>
<span class="line"></span>
<span class="line"><span class="token keyword">from</span> selenium <span class="token keyword">import</span> webdriver</span>
<span class="line"></span>
...
<span class="line">browser<span class="token punctuation">.</span>quit<span class="token punctuation">(</span><span class="token punctuation">)</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_3、鼠标和键盘操作" tabindex="-1"><a class="header-anchor" href="#_3、鼠标和键盘操作"><span>3、鼠标和键盘操作</span></a></h2>
<h3 id="_1-鼠标操作" tabindex="-1"><a class="header-anchor" href="#_1-鼠标操作"><span>(1) 鼠标操作</span></a></h3>
<p>在 Selenium 中，将操作鼠标的方法封装在<code v-pre>ActionChains</code>（动作链）类中。
实例化对象：<code v-pre>action = ActionChains(driver)</code>
使用到的方法：</p>
<div class="language-python line-numbers-mode" data-highlighter="prismjs" data-ext="py" data-title="py"><pre v-pre><code><span class="line"><span class="token comment"># 右击</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ol>
<li><code v-pre>perform()</code></li>
</ol>
<p>上述四个方法调用时，动作按顺序存储到了<code v-pre>ActionChains</code>实例对象中，调用<code v-pre>perform()</code>方法后，才会真正执行动作。</p>
<ol start="2">
<li><code v-pre>context_click()</code></li>
</ol>
<p>鼠标右击后，如果弹出浏览器默认菜单，selenium 未提供操作默认菜单的方法；如果弹出自定义菜单，则可根据元素定位操作自定义菜单。</p>
<p><strong>使用案例</strong></p>
<p><img src="@source/dev/test/web_test/img_24.png" alt="img_24.png"></p>
<div class="language-python line-numbers-mode" data-highlighter="prismjs" data-ext="py" data-title="py"><pre v-pre><code><span class="line"><span class="token keyword">import</span> time</span>
<span class="line"></span>
<span class="line"><span class="token keyword">from</span> selenium <span class="token keyword">import</span> webdriver</span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ol start="3">
<li><code v-pre>double_click()</code></li>
</ol>
<p><strong>使用案例</strong></p>
<p><img src="@source/dev/test/web_test/img_25.png" alt="img_25.png"></p>
<div class="language-python line-numbers-mode" data-highlighter="prismjs" data-ext="py" data-title="py"><pre v-pre><code><span class="line"><span class="token keyword">import</span> time</span>
<span class="line"></span>
<span class="line"><span class="token keyword">from</span> selenium <span class="token keyword">import</span> webdriver</span>
<span class="line"><span class="token keyword">from</span> selenium<span class="token punctuation">.</span>webdriver <span class="token keyword">import</span> ActionChains</span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ol start="4">
<li><code v-pre>drag_and_drop()</code></li>
</ol>
<p><strong>使用案例</strong></p>
<p><img src="@source/dev/test/web_test/img_26.png" alt="img_26.png"></p>
<div class="language-python line-numbers-mode" data-highlighter="prismjs" data-ext="py" data-title="py"><pre v-pre><code><span class="line"><span class="token keyword">import</span> time</span>
<span class="line"></span>
<span class="line"><span class="token keyword">from</span> selenium <span class="token keyword">import</span> webdriver</span>
<span class="line"><span class="token keyword">from</span> selenium<span class="token punctuation">.</span>webdriver <span class="token keyword">import</span> ActionChains</span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ol start="5">
<li><code v-pre>move_to_element()</code></li>
</ol>
<p><img src="@source/dev/test/web_test/img_27.png" alt="img_27.png"></p>
<div class="language-python line-numbers-mode" data-highlighter="prismjs" data-ext="py" data-title="py"><pre v-pre><code><span class="line"><span class="token keyword">import</span> time</span>
<span class="line"></span>
<span class="line"><span class="token keyword">from</span> selenium <span class="token keyword">import</span> webdriver</span>
<span class="line"><span class="token keyword">from</span> selenium<span class="token punctuation">.</span>webdriver <span class="token keyword">import</span> ActionChains</span>
...
<span class="line">browser<span class="token punctuation">.</span>quit<span class="token punctuation">(</span><span class="token punctuation">)</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-键盘操作" tabindex="-1"><a class="header-anchor" href="#_2-键盘操作"><span>(2) 键盘操作</span></a></h3>
<p>Selenium 将键盘按键封装在<code v-pre>Keys</code>中。</p>
<p>常用键盘操作：</p>
<p><img src="@source/dev/test/web_test/img_28.png" alt="img_28.png"></p>
<p><strong>使用案例</strong></p>
<p><img src="@source/dev/test/web_test/img_29.png" alt="img_29.png"></p>
<div class="language-python line-numbers-mode" data-highlighter="prismjs" data-ext="py" data-title="py"><pre v-pre><code><span class="line"><span class="token keyword">import</span> time</span>
<span class="line"></span>
<span class="line"><span class="token keyword">from</span> selenium <span class="token keyword">import</span> webdriver</span>
<span class="line"><span class="token keyword">from</span> selenium<span class="token punctuation">.</span>webdriver <span class="token keyword">import</span> ActionChains</span>
...
<span class="line">browser<span class="token punctuation">.</span>quit<span class="token punctuation">(</span><span class="token punctuation">)</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_4、元素等待" tabindex="-1"><a class="header-anchor" href="#_4、元素等待"><span>4、元素等待</span></a></h2>
<p>元素等待：定位元素时未找到，在指定时间内一直等待。</p>
<p>设置元素等待的原因：</p>
<p><img src="@source/dev/test/web_test/img_30.png" alt="img_30.png"></p>
<p>selenium 有两种元素等待类型：</p>
<ul>
<li>显式等待</li>
<li>隐式等待</li>
</ul>
<h3 id="_1-隐式等待" tabindex="-1"><a class="header-anchor" href="#_1-隐式等待"><span>(1) 隐式等待</span></a></h3>
<p><img src="@source/dev/test/web_test/img_31.png" alt="img_31.png"></p>
<p>隐式等待将为 driver 配置了最大等待时间，没有明显地设置了某个元素的最大等待时间。</p>
<p>语法：<code v-pre>driver.implicitly_wait(timeout)</code></p>
<ul>
<li><code v-pre>timeout</code>为等待最大时长，单位：秒</li>
</ul>
<p>隐式等待为全局配置，作用于驱动。</p>
<p><strong>使用案例</strong></p>
<p><img src="@source/dev/test/web_test/img_32.png" alt="img_32.png"></p>
<div class="language-python line-numbers-mode" data-highlighter="prismjs" data-ext="py" data-title="py"><pre v-pre><code><span class="line"><span class="token keyword">import</span> time</span>
<span class="line"></span>
<span class="line"><span class="token keyword">from</span> selenium <span class="token keyword">import</span> webdriver</span>
<span class="line"><span class="token keyword">from</span> selenium<span class="token punctuation">.</span>webdriver <span class="token keyword">import</span> ActionChains</span>
...
<span class="line">browser<span class="token punctuation">.</span>quit<span class="token punctuation">(</span><span class="token punctuation">)</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-显式等待" tabindex="-1"><a class="header-anchor" href="#_2-显式等待"><span>(2) 显式等待</span></a></h3>
<p><img src="@source/dev/test/web_test/img_34.png" alt="img_34.png"></p>
<p>显式等待很明显可以看出等待找寻某个特定元素。</p>
<p>Selenium 中将显示等待的相关方法封装在<code v-pre>WebDriverWait</code>类中。</p>
<p><img src="@source/dev/test/web_test/img_33.png" alt="img_33.png"></p>
<p><strong>使用案例</strong></p>
<p><img src="@source/dev/test/web_test/img_35.png" alt="img_35.png"></p>
<div class="language-python line-numbers-mode" data-highlighter="prismjs" data-ext="py" data-title="py"><pre v-pre><code><span class="line"><span class="token keyword">import</span> time</span>
<span class="line"></span>
<span class="line"><span class="token keyword">from</span> selenium <span class="token keyword">import</span> webdriver</span>
...
<span class="line">browser<span class="token punctuation">.</span>quit<span class="token punctuation">(</span><span class="token punctuation">)</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-显式等待和隐式等待区别" tabindex="-1"><a class="header-anchor" href="#_3-显式等待和隐式等待区别"><span>(3) 显式等待和隐式等待区别</span></a></h3>
<p><img src="@source/dev/test/web_test/img_36.png" alt="img_36.png"></p>
<h2 id="_5、下拉选择框、弹出框和滚动条操作" tabindex="-1"><a class="header-anchor" href="#_5、下拉选择框、弹出框和滚动条操作"><span>5、下拉选择框、弹出框和滚动条操作</span></a></h2>
<h3 id="_1-下拉选择框" tabindex="-1"><a class="header-anchor" href="#_1-下拉选择框"><span>(1) 下拉选择框</span></a></h3>
<p>下拉选择框就是 HTML 中的<code v-pre>&lt;select&gt;</code>元素。</p>
<p>selenium 为操作<code v-pre>&lt;select&gt;</code>标签封装了<code v-pre>Select</code>类。</p>
<p><img src="@source/dev/test/web_test/img_37.png" alt="img_37.png"></p>
<p><img src="@source/dev/test/web_test/img_38.png" alt="img_38.png"></p>
<p><strong>使用案例</strong></p>
<p><img src="@source/dev/test/web_test/img_39.png" alt="img_39.png"></p>
<div class="language-python line-numbers-mode" data-highlighter="prismjs" data-ext="py" data-title="py"><pre v-pre><code><span class="line"><span class="token keyword">import</span> time</span>
<span class="line"></span>
...
<span class="line">browser<span class="token punctuation">.</span>quit<span class="token punctuation">(</span><span class="token punctuation">)</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-弹出框处理" tabindex="-1"><a class="header-anchor" href="#_2-弹出框处理"><span>(2) 弹出框处理</span></a></h3>
<p><img src="@source/dev/test/web_test/img_40.png" alt="img_40.png"></p>
<p>selenium 中的弹出框处理方法：</p>
<p><img src="@source/dev/test/web_test/img_41.png" alt="img_41.png"></p>
<p><strong>使用案例</strong></p>
<p><img src="@source/dev/test/web_test/img_42.png" alt="img_42.png"></p>
<div class="language-python line-numbers-mode" data-highlighter="prismjs" data-ext="py" data-title="py"><pre v-pre><code><span class="line"><span class="token keyword">import</span> time</span>
<span class="line"></span>
<span class="line"><span class="token keyword">from</span> selenium <span class="token keyword">import</span> webdriver</span>
<span class="line"></span>
...
<span class="line">browser<span class="token punctuation">.</span>quit<span class="token punctuation">(</span><span class="token punctuation">)</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-滚动条操作" tabindex="-1"><a class="header-anchor" href="#_3-滚动条操作"><span>(3) 滚动条操作</span></a></h3>
<p>Selenium 中并无直接操作滚动条方法，其操作滚动条的实现是通过执行 js 脚本。</p>
<p><img src="@source/dev/test/web_test/img_43.png" alt="img_43.png"></p>
<p><strong>使用案例</strong></p>
<p><img src="@source/dev/test/web_test/img_44.png" alt="img_44.png"></p>
<div class="language-python line-numbers-mode" data-highlighter="prismjs" data-ext="py" data-title="py"><pre v-pre><code><span class="line"><span class="token keyword">import</span> time</span>
<span class="line"></span>
<span class="line"><span class="token keyword">from</span> selenium <span class="token keyword">import</span> webdriver</span>
<span class="line"></span>
...
<span class="line">browser<span class="token punctuation">.</span>quit<span class="token punctuation">(</span><span class="token punctuation">)</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_6、frame-切换、多窗口切换" tabindex="-1"><a class="header-anchor" href="#_6、frame-切换、多窗口切换"><span>6、frame 切换、多窗口切换</span></a></h2>
<h3 id="_1-frame-切换" tabindex="-1"><a class="header-anchor" href="#_1-frame-切换"><span>(1) frame 切换</span></a></h3>
<p>frame 简介：</p>
<p><img src="@source/dev/test/web_test/img_45.png" alt="img_45.png"></p>
<p>Selenium 对 frame 切换的封装：</p>
<p><img src="@source/dev/test/web_test/img_46.png" alt="img_46.png"></p>
<p><strong>使用案例</strong></p>
<p><img src="@source/dev/test/web_test/img_47.png" alt="img_47.png"></p>
<div class="language-python line-numbers-mode" data-highlighter="prismjs" data-ext="py" data-title="py"><pre v-pre><code><span class="line"><span class="token keyword">import</span> time</span>
<span class="line"></span>
<span class="line"><span class="token keyword">from</span> selenium <span class="token keyword">import</span> webdriver</span>
<span class="line"></span>
...
<span class="line">browser<span class="token punctuation">.</span>quit<span class="token punctuation">(</span><span class="token punctuation">)</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-多窗口切换" tabindex="-1"><a class="header-anchor" href="#_2-多窗口切换"><span>(2) 多窗口切换</span></a></h3>
<p><img src="@source/dev/test/web_test/img_48.png" alt="img_48.png"></p>
<p><img src="@source/dev/test/web_test/img_49.png" alt="img_49.png"></p>
<p><strong>使用案例</strong></p>
<p><img src="@source/dev/test/web_test/img_50.png" alt="img_50.png"></p>
<div class="language-python line-numbers-mode" data-highlighter="prismjs" data-ext="py" data-title="py"><pre v-pre><code><span class="line"><span class="token keyword">import</span> time</span>
<span class="line"></span>
<span class="line"><span class="token keyword">from</span> selenium <span class="token keyword">import</span> webdriver</span>
<span class="line"></span>
...
<span class="line">browser<span class="token punctuation">.</span>quit<span class="token punctuation">(</span><span class="token punctuation">)</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_7、窗口截图、验证码处理" tabindex="-1"><a class="header-anchor" href="#_7、窗口截图、验证码处理"><span>7、窗口截图、验证码处理</span></a></h2>
<h3 id="_1-窗口截图" tabindex="-1"><a class="header-anchor" href="#_1-窗口截图"><span>(1) 窗口截图</span></a></h3>
<p><img src="@source/dev/test/web_test/img_51.png" alt="img_51.png"></p>
<p><strong>使用案例</strong></p>
<p><img src="@source/dev/test/web_test/img_52.png" alt="img_52.png"></p>
<div class="language-python line-numbers-mode" data-highlighter="prismjs" data-ext="py" data-title="py"><pre v-pre><code><span class="line"><span class="token keyword">import</span> time</span>
<span class="line"></span>
<span class="line"><span class="token keyword">from</span> selenium <span class="token keyword">import</span> webdriver</span>
<span class="line"></span>
...
<span class="line">browser<span class="token punctuation">.</span>quit<span class="token punctuation">(</span><span class="token punctuation">)</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-验证码处理" tabindex="-1"><a class="header-anchor" href="#_2-验证码处理"><span>(2) 验证码处理</span></a></h3>
<h4 id="_1-验证码的处理方式" tabindex="-1"><a class="header-anchor" href="#_1-验证码的处理方式"><span>1.验证码的处理方式</span></a></h4>
<p><img src="@source/dev/test/web_test/img_53.png" alt="img_53.png">
<img src="@source/dev/test/web_test/img_54.png" alt="img_54.png"></p>
<h4 id="_2-cookie-介绍" tabindex="-1"><a class="header-anchor" href="#_2-cookie-介绍"><span>2.Cookie 介绍</span></a></h4>
<p><img src="@source/dev/test/web_test/img_55.png" alt="img_55.png">
<img src="@source/dev/test/web_test/img_56.png" alt="img_56.png">
总结：Cookie 是 Web 服务器颁发的，存储在客户端浏览器中的，用于标识用户状态的小文本文件。
应用场景：</p>
<ul>
<li>实现会话跟踪，记录用户登录状态</li>
<li>实现记住密码和自动登录功能</li>
<li>用户未登录情况下，记录购物车中的商品</li>
</ul>
<h4 id="_3-selenium-操作-cookie" tabindex="-1"><a class="header-anchor" href="#_3-selenium-操作-cookie"><span>3.Selenium 操作 cookie</span></a></h4>
<p><img src="@source/dev/test/web_test/img_57.png" alt="img_57.png"></p>
<p><strong>使用案例</strong></p>
<p><img src="@source/dev/test/web_test/img_58.png" alt="img_58.png"></p>
<p><img src="@source/dev/test/web_test/img_59.png" alt="img_59.png"></p>
<div class="language-python line-numbers-mode" data-highlighter="prismjs" data-ext="py" data-title="py"><pre v-pre><code><span class="line"><span class="token keyword">import</span> time</span>
<span class="line"></span>
<span class="line"><span class="token keyword">from</span> selenium <span class="token keyword">import</span> webdriver</span>
<span class="line"></span>
