<template><div><h1 id="一、k-近邻算法" tabindex="-1"><a class="header-anchor" href="#一、k-近邻算法"><span>一、K 近邻算法</span></a></h1>
<p>KNN（K-Nearest Neighbors）算法是一种常见的监督学习算法，主要用于分类和回归问题。它的思想是基于相似性度量，将未知样本的类别或属性值，赋值为其最近邻居的类别或属性值。</p>
<p>在 KNN 算法中，K 表示最近邻的个数。在分类问题中，KNN 算法会统计与待分类样本最近的K 个样本的类别，通过多数投票的方式来判断待分类样本的类别。在回归问题中，KNN 算法会统计与待预测样本最近的 K 个样本的属性值，通过取平均值的方式来预测待预测样本的属性值。</p>
<p>KNN 算法需要预先确定距离度量方法，常用的距离度量方法包括欧氏距离、曼哈顿距离和余弦相似度等。KNN 算法的优点包括简单易懂，无需训练，适用于多分类和高维数据，但是它也存在一些缺点，如对异常值敏感，需要存储所有训练样本等。</p>
<p>KNN 算法是一种懒惰学习（lazy learning）算法，它不需要训练阶段，只需要存储训练集中的样本和对应的类别（或属性值）。当需要对未知样本进行分类或回归时，KNN算法才进行计算。</p>
<h2 id="_1、算法原理" tabindex="-1"><a class="header-anchor" href="#_1、算法原理"><span>1、算法原理</span></a></h2>
<p>KNN（K-Nearest Neighbors）算法的原理是基于样本之间的相似性度量来进行分类或回归。其基本思想是：如果一个样本在特征空间中的K个最相似的样本中，大多数属于某个类别，则该样本也属于这个类别。因此，KNN算法的关键就是如何度量样本之间的相似性。</p>
<h2 id="_2、算法步骤" tabindex="-1"><a class="header-anchor" href="#_2、算法步骤"><span>2、算法步骤</span></a></h2>
<ol>
<li>
<p>计算未知样本与训练集中所有样本之间的距离（或相似度），并选取距离最近的K个样本。</p>
</li>
<li>
<p>根据K个最近邻样本的类别（或属性值），通过投票的方式来预测未知样本的类别（或属性值）。如果是分类问题，则未知样本的类别为K个最近邻样本中出现次数最多的类别；如果是回归问题，则未知样本的属性值为K个最近邻样本属性值的平均值。</p>
</li>
</ol>
<h2 id="_3、算法特点" tabindex="-1"><a class="header-anchor" href="#_3、算法特点"><span>3、算法特点</span></a></h2>
<ol>
<li>
<p>简单易懂：KNN算法的思想简单易懂，容易理解和实现。</p>
</li>
<li>
<p>无需训练：KNN算法是一种懒惰学习（lazy learning）算法，不需要训练阶段，只需要存储训练集中的样本和对应的类别（或属性值），因此可以快速进行预测。</p>
</li>
<li>
<p>适用于多分类问题：KNN算法适用于多分类问题，可以将样本分为多个类别。</p>
</li>
<li>
<p>适用于高维数据：KNN算法适用于高维数据，不需要对数据进行降维处理。</p>
</li>
<li>
<p>对异常值敏感：KNN算法对异常值敏感，因为它是基于距离度量的，如果某个样本距离待分类样本很近，但是它的类别与待分类样本差异较大，就会影响预测结果。</p>
</li>
<li>
<p>存储空间大：KNN算法需要存储所有训练样本，因此存储空间较大。</p>
</li>
<li>
<p>计算复杂度高：KNN算法需要计算待分类样本和所有训练样本之间的距离，计算复杂度较高，尤其是当训练集较大时。</p>
</li>
</ol>
<h2 id="_4、代码实战" tabindex="-1"><a class="header-anchor" href="#_4、代码实战"><span>4、代码实战</span></a></h2>
<h3 id="_1-双特征二分类模拟数据集" tabindex="-1"><a class="header-anchor" href="#_1-双特征二分类模拟数据集"><span>(1) 双特征二分类模拟数据集</span></a></h3>
<div class="language-python line-numbers-mode" data-highlighter="prismjs" data-ext="py" data-title="py"><pre v-pre><code><span class="line"><span class="token keyword">def</span> <span class="token function">createDataSet</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">:</span></span>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-python line-numbers-mode" data-highlighter="prismjs" data-ext="py" data-title="py"><pre v-pre><code><span class="line"><span class="token comment"># knn分类器</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-python line-numbers-mode" data-highlighter="prismjs" data-ext="py" data-title="py"><pre v-pre><code><span class="line"><span class="token keyword">def</span> <span class="token function">test1</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">:</span></span>
<span class="line">    <span class="token triple-quoted-string string">"""</span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-python line-numbers-mode" data-highlighter="prismjs" data-ext="py" data-title="py"><pre v-pre><code><span class="line"><span class="token keyword">if</span> __name__ <span class="token operator">==</span> <span class="token string">'__main__'</span><span class="token punctuation">:</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-三特征三分类——约会对象" tabindex="-1"><a class="header-anchor" href="#_2-三特征三分类——约会对象"><span>(2) 三特征三分类——约会对象</span></a></h3>
<h4 id="_1-项目概述与数据集概述" tabindex="-1"><a class="header-anchor" href="#_1-项目概述与数据集概述"><span>1. 项目概述与数据集概述</span></a></h4>
<p><img src="@source/ml/traditional_ml/img.png" alt="img.png">
<img src="@source/ml/traditional_ml/img_1.png" alt="img_1.png"></p>
<h4 id="_2-具体代码" tabindex="-1"><a class="header-anchor" href="#_2-具体代码"><span>2. 具体代码</span></a></h4>
<p><strong>导入数据</strong>
将 txt 中的数据导入，生成数据矩阵和标签向量</p>
<div class="language-python line-numbers-mode" data-highlighter="prismjs" data-ext="py" data-title="py"><pre v-pre><code><span class="line"><span class="token keyword">def</span> <span class="token function">file2matrix</span><span class="token punctuation">(</span>filename<span class="token punctuation">)</span><span class="token punctuation">:</span></span>
<span class="line">    <span class="token triple-quoted-string string">"""</span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>数据归一化</strong></p>
<p>数据归一化是指将数据按照一定的比例缩放，使其落在一个特定的区间内，常用的区间为[0,1]或[-1,1]。归一化的目的是消除不同特征之间的量纲影响，将其转化为同一标准下的数值，以便进行比较和分析。这样可以提高机器学习算法的精度和效率，避免某些特征因数值过大而对算法产生较大影响的情况。数据归一化通常可以使用简单的线性变换方法实现，例如最小-最大缩放方法和z-score标准化方法。</p>
<div class="language-python line-numbers-mode" data-highlighter="prismjs" data-ext="py" data-title="py"><pre v-pre><code><span class="line"><span class="token keyword">def</span> <span class="token function">autoNorm</span><span class="token punctuation">(</span>dataSet<span class="token punctuation">)</span><span class="token punctuation">:</span></span>
<span class="line">    <span class="token triple-quoted-string string">"""</span>
...
<div class="language-python line-numbers-mode" data-highlighter="prismjs" data-ext="py" data-title="py"><pre v-pre><code><span class="line"><span class="token keyword">def</span> <span class="token function">datingClassTest</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">:</span></span>
<span class="line">    <span class="token triple-quoted-string string">"""</span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-1024-特征-10-分类——手写字体" tabindex="-1"><a class="header-anchor" href="#_3-1024-特征-10-分类——手写字体"><span>(3) 1024 特征 10 分类——手写字体</span></a></h3>
<h4 id="_1-项目概述和数据集概述" tabindex="-1"><a class="header-anchor" href="#_1-项目概述和数据集概述"><span>1. 项目概述和数据集概述</span></a></h4>
<p><img src="@source/ml/traditional_ml/img_2.png" alt="img_2.png"></p>
<h4 id="_2-具体代码-1" tabindex="-1"><a class="header-anchor" href="#_2-具体代码-1"><span>2. 具体代码</span></a></h4>
<p><strong>图像转向量</strong></p>
<p>首先需要将 32<em>32 的黑白图像转换为 1</em>1024 的特征向量。</p>
<div class="language-python line-numbers-mode" data-highlighter="prismjs" data-ext="py" data-title="py"><pre v-pre><code><span class="line"><span class="token keyword">def</span> <span class="token function">img2vector</span><span class="token punctuation">(</span>filename<span class="token punctuation">)</span><span class="token punctuation">:</span></span>
<span class="line">    <span class="token triple-quoted-string string">"""</span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>测试代码</strong></p>
<div class="language-python line-numbers-mode" data-highlighter="prismjs" data-ext="py" data-title="py"><pre v-pre><code><span class="line"><span class="token keyword">def</span> <span class="token function">handwritingClassTest</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">:</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_5、sklearn-中的-knn" tabindex="-1"><a class="header-anchor" href="#_5、sklearn-中的-knn"><span>5、sklearn 中的 knn</span></a></h2>
<h3 id="_1-使用案例-鸢尾花" tabindex="-1"><a class="header-anchor" href="#_1-使用案例-鸢尾花"><span>(1) 使用案例：鸢尾花</span></a></h3>
<div class="language-python line-numbers-mode" data-highlighter="prismjs" data-ext="py" data-title="py"><pre v-pre><code><span class="line"><span class="token keyword">from</span> sklearn<span class="token punctuation">.</span>neighbors <span class="token keyword">import</span> KNeighborsClassifier</span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-约会对象" tabindex="-1"><a class="header-anchor" href="#_2-约会对象"><span>(2) 约会对象</span></a></h3>
<div class="language-python line-numbers-mode" data-highlighter="prismjs" data-ext="py" data-title="py"><pre v-pre><code><span class="line"><span class="token keyword">from</span> sklearn<span class="token punctuation">.</span>neighbors <span class="token keyword">import</span> KNeighborsClassifier</span>
...
<span class="line"><span class="token keyword">print</span><span class="token punctuation">(</span><span class="token string">'Accuracy:'</span><span class="token punctuation">,</span> accuracy<span class="token punctuation">)</span></span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-手写字体识别" tabindex="-1"><a class="header-anchor" href="#_3-手写字体识别"><span>(3) 手写字体识别</span></a></h3>
<div class="language-python line-numbers-mode" data-highlighter="prismjs" data-ext="py" data-title="py"><pre v-pre><code><span class="line"><span class="token keyword">from</span> sklearn<span class="token punctuation">.</span>neighbors <span class="token keyword">import</span> KNeighborsClassifier</span>
